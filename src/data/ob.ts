 ...
 * 老陈（陈彦川）不在十人名单里，但他是 OB 前身「龙宝川」三人组的成员，按"编外"收录。
 *
 * 两条注意：
...
export const OB_MEMBERS: ObMember[] = [
	...
	},
	{
		...
		tag: 'OB 前身「龙宝川」成员',
		description:
			'OB 的前身是「周宝龙」解说三人组（Zhou、龙弟弟、宝哥），而「周宝龙」的前身正是「龙宝川」——川就是屠夫阿川、老陈。他辈分最老，却不在十人正式名单里：2019 年后的历次名单都没有他，媒体口径是「OB 天团的好朋友」，所以按「编外」收录。',
		jokes: ['华府双雄（与龙神）', '做菜（操作失误）', '战地记者', '理财大师', '下饭三幻神'],
	},
];

/** 十人正式成员，用于页面上的分组与计数。 */
export const OB_FULL_MEMBERS = OB_MEMBERS.filter((m) => m.membership === '正式成员');
